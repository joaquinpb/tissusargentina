...
function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#20b858] hover:scale-110 transition-all duration-200"
    >
